...
const PREVIEW_URL = 'https://aolabs.io/previews/willyernarplayleague-20260724-v3.png';
...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="/icon.svg?v=20260724-yernar-league-v3" type="image/svg+xml">
    <link rel="apple-touch-icon" href="/icon.svg?v=20260724-yernar-league-v3">
    <link rel="manifest" href="/site.webmanifest?v=20260724-yernar-league-v3">
    ...
    <header class="suite-topbar" aria-label="will yernar play league navigation">
      <div class="suite-brand-cluster">
        ...
        <a class="suite-app-brand" href="/" aria-label="will yernar play league home">
          <img class="suite-app-mark" src="/icon.svg?v=20260724-yernar-league-v3" alt="">
