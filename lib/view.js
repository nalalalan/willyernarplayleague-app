...
function renderPrediction(state) {
  const action = state.canRecordOutcome
    ? renderOutcomeActions(state.yesActionLabel, state.actionLabel)
    : '';
...
function renderOutcomeActions(yesLabel = 'yes league slay', noLabel = 'no league') {
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/styles.css?v=20260724-yes-league-v1">
    <script src="/chart.js?v=20260724-ticks-only-v1" defer></script>
    <script src="/app.js?v=20260724-yes-league-v1" defer></script>
  </head>
  <body>
