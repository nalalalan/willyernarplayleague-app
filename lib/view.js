...
function renderPrediction(state) {
  const answered = typeof state.todayOutcome === 'boolean';
  return `<section class="prediction" aria-live="polite" aria-atomic="true">
    ...
    <div class="answer-area" data-answer-area>
      ${answered ? `<button class="change-answer" type="button" data-change>change answer</button>` : renderQuestion()}
    </div>
...
function renderQuestion() {
  return `<p class="question">did yernar play league?</p>
    <div class="answer-buttons">
      <button class="answer-button answer-yes" type="button" data-played="true">yes</button>
      <button class="answer-button answer-no" type="button" data-played="false">no</button>
    </div>`;
}
...
<html lang="en">
  <head>
    ...
    <script src="/app.js?v=20260723" defer></script>
  </head>
  <body>
